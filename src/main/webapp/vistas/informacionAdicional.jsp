...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="modal fade" id="modal-default">
            ...
            <div class="modal-dialog modal-default">
                <!-- modal-dialog-centered, esta clase permite que se centre el modal-->
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Formulario De Registro</h4>
                        <button type="button" class="close" data-dismiss="modal" onclick="clearFields()"
                                aria-label="Close">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="nombreInfAdic" type="text" placeholder="Ingrese Nombre"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button id="btnSave" onclick="registrar()" type="button" class="btn btn-primary"><i
                                class="fas fa-save"></i> Registrar Información Adicional
                        </button>
                    </div>
                </div>
                <!-- /.modal-content -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button id="btnRegistrarInfAdic" type="button" class="btn btn-outline-primary"
                                        data-toggle="modal" data-backdrop="static" data-keyboard="false"
                                        data-target="#modal-default"><i class="fas fa-file-signature"></i> Nuevo
                                    Registro
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table style="text-align: center" id="TablaInfAdic"
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021-2025 <a href="https://adminlte.io">DevSoft</a>.</strong> Todos los derechos
        reservados.
    </footer>
</div>
